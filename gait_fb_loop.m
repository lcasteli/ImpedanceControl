...
%         dir((kk-1)*hh+1:kk*hh,1)=180;
%     else
%         dir((kk-1)*hh+1:kk*hh,1)=0;
%     end        
    ...
    % Combine data
    ankle_angles_in.signals.values = ankle_angle_data;
    ankle_trans_in.signals.values = ankle_trans_data;
    shin_angles_in.signals.values = shin_angle_data;
